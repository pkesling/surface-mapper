...
### Added
- Initial SurfaceMapper CLI pipeline:
...
- Public launch checklist (`docs/release_checklist.md`).
...
- Package versioning now uses a pre-release value (`0.1.0.dev0`) and metadata-backed `surface_mapper.__version__`.
